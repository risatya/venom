function save() {
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseURL() + "index.php/inputhistory/save/",
            data: "idx=" + $("#idx").val() + "&history=" + $("#history").val() + "&img=" + encodeURIComponent($("#images_slider").val()) + "&description=" + encodeURIComponent(textbox)  + "&ishome=" + $("#is_home").val(),
            cache: false,
            dataType: 'json',
            type: 'POST',
            beforeSend: function() {
...
function deletedata(idx, title) {
    if (confirm('Hapus data ' + title + ' ?')) {
        $(document).ready(function() {
            ...
            $.ajax({
                url: getBaseURL() + "index.php/inputhistory/delete/",
                data: "idx=" + idx,
                cache: false,
                dataType: 'json',
                type: 'POST',
...
function search(xstart, xSearch) {
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseURL() + "index.php/inputhistory/search/",
...
function add(xid) {
    $(document).ready(function() {
        $.ajax({
            url: getBaseURL() + "index.php/inputhistory/getfromadd/",
            data: "idx=" + xid,
            cache: false,
            dataType: 'json',
            type: 'POST',
