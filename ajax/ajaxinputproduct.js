function save() {
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseURL() + "index.php/inputproduct/save/",
            data: "idx=" + $("#idx").val() + "&product=" + $("#product").val() + "&img=" + encodeURIComponent($("#images_slider").val()) + "&description=" + encodeURIComponent(textbox)  + "&is_home=" + $("#is_home").val()+ "&idcategory=" + $("#idcategory").val()+"&is_sliderhome="+$("#is_sliderhome").val(),
            cache: false,
            dataType: 'json',
            type: 'POST',
            beforeSend: function() {
...
function deletedata(idx, title) {
    if (confirm('Hapus data ' + title + ' ?')) {
        $(document).ready(function() {
            ...
            $.ajax({
                url: getBaseURL() + "index.php/inputproduct/delete/",
                data: "idx=" + idx,
                cache: false,
                dataType: 'json',
                type: 'POST',
...
function search(xstart, xSearch) {
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseURL() + "index.php/inputproduct/search/",
...
function add(xid) {
    $(document).ready(function() {
        $.ajax({
            url: getBaseURL() + "index.php/inputproduct/getfromadd/",
            data: "idx=" + xid,
            cache: false,
            dataType: 'json',
            type: 'POST',
