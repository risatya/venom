function save() {
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseURL() + "index.php/inputcategory/save/",
            data: "idx=" + $("#idx").val() + "&category=" + $("#category").val() + "&parent=" + $("#parent").val() + "&isnav=" + $("#isnav").val() + "&sort_order=" + $("#sort_order").val()+"&bentuk_tampilan="+$("#bentuk_tampilan").val()+"&link="+$("#link").val(),
            cache: false,
            dataType: 'json',
            type: 'POST',
            beforeSend: function() {
...
function deletedata(idx, title) {
    if (confirm('Hapus data ' + title + ' ?')) {
        $(document).ready(function() {
            ...
            $.ajax({
                url: getBaseURL() + "index.php/inputcategory/delete/",
                data: "idx=" + idx,
                cache: false,
                dataType: 'json',
                type: 'POST',
...
function add(xid) {
    $(document).ready(function() {
        $.ajax({
            url: getBaseURL() + "index.php/inputcategory/getfromadd/",
            data: "idx=" + xid,
            cache: false,
            dataType: 'json',
            type: 'POST',
