...
echo "			
			...
			<br>
			<br>
			<b ><div align='center' style='min-height:40px'><a href='".base_url()."product/detail/$row->idproduct' style='color:#000;text-decoration:none'>$row->product</a></div> </b>&nbsp;&nbsp;&nbsp;</td></tr></table> 
			</td>
			<td>
			&nbsp;
			</td>
