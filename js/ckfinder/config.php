...
*/
//$baseUrl = 'http://www.garudabrussels.eu/demo/uploaded/';

$baseUrl='http://smartdesainer.com/venom/uploaded/';
///$baseUrl='http://localhost/prudential/images/';
//$baseUrl = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
//$baseUrl .= "://".$_SERVER['HTTP_HOST'];
//$baseUrl .= preg_replace('@/+$@','',dirname($_SERVER['SCRIPT_NAME'])).'/uploaded';
$enabled = true;
/*
